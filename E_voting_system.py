...
con = pyodbc.connect((r'DRIVER={Microsoft Access Driver (*.mdb, *.accdb)};'
                      r'DBQ=C:\Users\tooba\Documents\PD.accdb;'))


root2 = customtkinter.CTk()
root2.title("User Login")
customtkinter.set_default_color_theme("green")
lion_original = PhotoImage(file="C:\\Users\\tooba\\Pictures\\Saved Pictures\\5b4ee57146316.png")
bat_original = PhotoImage(file="C:\\Users\\tooba\\Pictures\\Saved Pictures\\PTI_Symbol_Elections.png")
arrow_original = PhotoImage(file="C:\\Users\\tooba\\Pictures\\Saved Pictures\\ppp arrow.png")
balance_original = PhotoImage(file="C:\\Users\\tooba\\Pictures\\Saved Pictures\\5b4ee75074c57.png")
...
def mainwindow():
    ...
    ecp_banner = PhotoImage(file="C:\\Users\\tooba\\Pictures\\Saved Pictures\\Untitled2.png")
    ...
    def user_frame():
        ...
        for i in range(0, 10):
            if i == 3:
                ...
                formatted_date = date_string.strftime('%d/%m/%Y')  # Change the format as per your requirement
    ...
    def display_election_results(constituency_code, frame):
        ...
        if constituency_name:
            ...
            if result[0] == 0:
                ...
                cursor.execute(f"SELECT [Candidate Name] FROM [MNA Candidates] WHERE ([Constituency code] = "
                               f"'{constituency_code}' AND Party = '{winner_party2}')")
...
def reg_page():
    ...
    enter_fn = customtkinter.CTkEntry(master=left_frame1, bg_color="white", border_width=2, border_color="gray",
                                      width=200, placeholder_text="Enter Father's Name", height=40)
    enter_fn.place(relx=0.5, rely=0.42, anchor=tkinter.CENTER)
    enter_city = customtkinter.CTkEntry(master=left_frame1, bg_color="white", border_width=2, border_color="gray",
                                        width=200, placeholder_text="Enter City Of Residence", height=40)
    enter_city.place(relx=0.5, rely=0.48, anchor=tkinter.CENTER)
    enter_dob = customtkinter.CTkEntry(master=left_frame1, bg_color="white", border_width=2, border_color="gray",
                                       width=200, placeholder_text="Enter Date Of Birth", height=40)
    enter_dob.place(relx=0.5, rely=0.54, anchor=tkinter.CENTER)
    enter_gender = customtkinter.CTkEntry(master=left_frame1, bg_color="white", border_width=2, border_color="gray",
                                          width=200, placeholder_text="Enter Gender", height=40)
    enter_gender.place(relx=0.5, rely=0.6, anchor=tkinter.CENTER)
...
PEC_logo = PhotoImage(file="C:\\Users\\tooba\\Pictures\\Saved Pictures\\logo.png")
